    ...
    return (
        <main className="py-2">
            ...
            <div className="px-3">
                ...
                {videoDetails?.map(data=>{
                    return (
                        <div className="w-full border bg-gray-200 space-y-3 p-2 rounded-lg overflow-hidden mb-3  md:mb-2">
                        ...
                        return (
                            <div className="flex mb-3">
                                ...
                                <div className="px-3">
                                    ...
                                    <p className="leading-5">{data.snippet.topLevelComment.snippet.textDisplay}</p>
